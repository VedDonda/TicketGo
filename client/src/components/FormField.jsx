...
export default function FormField({
  ...
  const baseInputClass =
    "w-full px-4 py-3 bg-bg-input border-[1.5px] border-border rounded-sm text-text-primary font-inter text-[0.9rem] outline-none transition-all duration-200 placeholder:text-text-muted focus:border-border-focus focus:bg-bg-input-focus focus:shadow-[0_0_0_3px_rgba(91,95,199,0.15)]";
  const errorInputClass =
    "!border-error !shadow-[0_0_0_3px_rgba(224,92,106,0.15)]";
  ...
  return (
    <div className="mb-[18px]">
      <label
        htmlFor={id}
        className="block text-[0.825rem] font-semibold text-text-primary mb-[7px]"
      >
        {label}
